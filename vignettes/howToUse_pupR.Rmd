...
Now we are ready to estimate the pup abundance. First we use a method developed by Kingsley (ref). This method requires that the data is on a strip transect format. We use the `kingsley` function and we often estimate the number of pubs based on both the uncorrected pup counts and the corrected pup counts.
